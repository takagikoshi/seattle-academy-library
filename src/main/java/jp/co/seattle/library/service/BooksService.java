...
public class BooksService {
    ...
    public BookDetailsInfo getBookInfo(int bookId) {
        ...
        // JSPに渡すデータを設定する
        String sql = "SELECT * ,case WHEN book_id is null THEN '貸し出し可' ELSE '貸し出し中' end AS status FROM books left outer join borrow on books.id = borrow.book_id where books.id ="+bookId;
